...
const btnScrollYo = document.querySelector('.btn--scroll-to');
...
///////////////////////////////////////////////
// Button scroll
btnScrollYo.addEventListener('click', function (e) {
  const s1coords = section1.getBoundingClientRect();
  console.log(s1coords);
  // console.log(e.target.getBoundingClientRect());
  // console.log('Current scroll X/Y', window.pageXOffset, window.pageYOffset);
  // console.log(
  //   'heighr/width vievport',
...
message.style.height =
  Number.parseFloat(getComputedStyle(message).height, 10) + 42 + 'px';
